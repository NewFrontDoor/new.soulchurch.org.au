...
export function CurrentSeries({latestSermon}) {
  ...
  return (
    <section>
      ...
      <Link to={'/series/' + latestSermon.series_id}>
        <Styled.p dangerouslySetInnerHTML={{__html: latestSermon.sermonseries}} />
      </Link>
    </section>
  );
}
    ...
    <section>
      ...
      <Link to={`/sermon/${latestSermon.nid}`}>
        {latestSermon.node_title ? (
          <Styled.p dangerouslySetInnerHTML={{__html: latestSermon.node_title}} />
        ) : (
          <Styled.p>Untitled</Styled.p>
        )}
      </Link>
      <Styled.p dangerouslySetInnerHTML={{__html: latestSermon.preacher}} />
    </section>
  );
}
